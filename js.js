/**
 * impress.jsnnnnnnnnnnnnnnhhhhhhhhhhhhhhhhh
 *vvvvvvvvvvvvvvhhhhhhhhhhhhhhh
 * impress.js is a presentation tool based on the power of CSS3 transforms and transitions
 * in modern browsers and inspired by the idea behind prezi.com.nnnnnnnnnnnnnnn
 *
 *bbbbbbbbbbbbbbbbbbrrrrrrrrrrrr
 * Copyright 2011-2012 Bartek Szopka (@bartaz)nnnnnnnnnnnnn
 *fffffffffffffffff document.get
 * Released under the MIT and GPL Licenses.bbbbbbbbbbbnnnnnnnnnnnnn
 *
 * ------------------------------------------------
...
fucntio
    ...
    var bbbb = document.getElementById.toLower
    // CHECK SUPPORT
...
docum                rotate:    { x: 0, y: 0, z: 0 },
        ...
        // `getStep` is a helper function that returns a step element defined by parameter.       // If a number is given, step with index given by the number is returned, if a string
